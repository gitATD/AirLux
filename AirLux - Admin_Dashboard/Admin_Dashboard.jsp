...
<body style="background: var(--bs-gray-900);">
    ...
    <header>
        <nav class="navbar navbar-dark navbar-expand-md fixed-top bg-dark bg-gradient py-3">
            <div class="container"><a class="navbar-brand d-flex align-items-center"><span class="fw-light" style="transform: scale(1.42);">AirLux</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-5"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <div></div>
    <form method = "POST" action = "http://localhost:8888/Ashutosh/jsp/AirLux - Admin_Search_Results/Admin_Search_Results.jsp">
        <section style="margin-top: 84px;">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="card" data-aos="fade-down" style="height: 110px;">
                            <div class="card-body">
                                <h4 class="fw-normal card-title">Booking</h4>
                                <div class="row" style="margin-top: 0px;">
                                    <div class="col-auto m-auto"><label class="col-form-label">Enter a particular booking ID</label></div>
                                    <div class="col-auto m-auto"><input class="form-control" type="text" placeholder="Booking ID" name="booking_id"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="card" data-aos="fade-down" style="height: 110px;">
                            <div class="card-body">
                                <h4 class="fw-normal card-title">Passenger</h4>
                                <div class="row" style="margin-top: 0px;">
                                    <div class="col-auto m-auto"><label class="col-form-label">Enter a particular passenger name</label></div>
                                    <div class="col-auto m-auto"><input class="form-control" type="text" placeholder="Passenger's Name" name="passenger_name"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="card" data-aos="fade-down" style="height: 110px;">
                            <div class="card-body">
                                <h4 class="fw-normal card-title">Flight</h4>
                                <div class="row" style="margin-top: 0px;">
                                    <div class="col-auto m-auto"><label class="col-form-label">Enter a particular flight no</label></div>
                                    <div class="col-auto m-auto"><input class="form-control" type="text" placeholder="Flight No" name="flight_no"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="card" data-aos="fade-down" style="height: 110px;">
                            <div class="card-body">
                                <button class="btn btn-primary fw-light d-block w-100" data-bss-hover-animate="pulse" type="submit" style="font-family: Eras ITC;background: var(--bs-gray-900);">Search</button>
                            </div>
                        </div>
                    </div>
                </div>
